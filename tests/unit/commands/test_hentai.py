...
from bot.domain.commands.hentai import HentaiCommand, HentaiGallery, HitomiScraper, NhentaiScraper
...
def nhentai_route(respx_mock):
    return respx_mock.get(url__startswith='https://nhentai.net/api/gallery/')
